#!/usr/bin/env python3
"""CLI for the Minimal6 self-consistent potential replacement experiment."""
...
from scripts.pn2d_minimal6_diagnostics.self_consistent_replacement import (
    run_self_consistent_replacement_experiment,
)
...
def main() -> int:
    args = parse_args()
    manifest = run_self_consistent_replacement_experiment(
        ...
        json.dumps(
            {
                ...
                "state_count": manifest["state_contract"]["state_count"],
                "maximum_recovered_ni_gap_dex": manifest[
                    "maximum_recovered_ni_gap_dex"
                ],
            },
            sort_keys=True,
        )

...
| --- | --- | --- | --- |
| `ni_eff/BGN` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) `EffectiveIntrinsicDensity(OldSlotboom)` and [models.par](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/models.par) `OldSlotboom` | [independent function](../../scripts/pn2d_minimal6_diagnostics/physics.py) `infer_ni_eff`; `counterfactual._formula_ni` | [C++ helper](../../include/vela/discretization/ScharfetterGummel.h) `sgElectronContinuityFluxFromQuasiFermiVariableNi` / `sgHoleContinuityFluxFromQuasiFermiVariableNi` |
| `gradient_recovery` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) exported potential/current controls | [independent function](../../scripts/pn2d_minimal6_diagnostics/counterfactual.py) `_formula_gradient`; support projections in `support.py` | [C++ helper](../../include/vela/equation/AssemblerUtils.h) `cellScalarGradient` / `edgeAveragedCellScalarGradient` |
| `mobility` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) `Mobility(DopingDependence HighFieldSaturation)` and [models.par](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/models.par) mobility parameters | [independent function](../../scripts/pn2d_minimal6_diagnostics/counterfactual.py) `_formula_mobility` | [C++ helper](../../include/vela/equation/AssemblerUtils.h) `edgeMobility` / `triangleGssEndpointAveragedMobility` |
| `current_semantics` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) `eCurrentDensity/Vector` and `hCurrentDensity/Vector` | [independent function](../../scripts/pn2d_minimal6_diagnostics/counterfactual.py) `_formula_current` | [C++ helper](../../include/vela/equation/AssemblerUtils.h) `selectAvalancheCurrentFluxProxy` / `sgEdgeCurrentAvalancheSourceRecords` |
| `impact_driving_field` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) `Avalanche(VanOverstraeten)` | [independent function](../../scripts/pn2d_minimal6_diagnostics/counterfactual.py) `_formula_impact_field` | [C++ helper](../../include/vela/equation/AssemblerUtils.h) `electronAvalancheDrivingField` / `holeAvalancheDrivingField` |
| `alpha_law` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) `eAlphaAvalanche` / `hAlphaAvalanche` and [models.par](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/models.par) `vanOverstraetendeMan` | [independent function](../../scripts/pn2d_minimal6_diagnostics/physics.py) `van_overstraeten_alpha`; `counterfactual._formula_alpha` | [C++ helper](../../src/physics/ImpactIonizationModel.cpp) `VanOverstraetenImpactIonization::electronCoefficient` / `holeCoefficient` |
| `partial_volume` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) native `AvalancheGeneration` support control | [independent function](../../scripts/pn2d_minimal6_diagnostics/counterfactual.py) `_formula_partial_volume`; `support.integrate_cell_field` | [C++ helper](../../include/vela/equation/AssemblerUtils.h) `avalancheSourceEdgeArea` / `sgEdgeCurrentAvalancheSourceRecords` |
| `source_to_node_mapping` | [state deck](../../reference_tcad/pn2d_sentaurus2018_minimal6/source/pn2d_minimal6_state_sdevice.cmd) native `AvalancheGeneration` mapping boundary | [independent function](../../scripts/pn2d_minimal6_diagnostics/counterfactual.py) `_formula_source_mapping`; `support.local_edge_sources_to_nodes` | [C++ helper](../../include/vela/equation/AssemblerUtils.h) `sgEdgeCurrentAvalancheSourceComponentIntegrals`; [assembler entry](../../src/equation/CoupledDDAssembler.cpp) continuity-source assembly |
